...
export default function Unit3Screen({ navigation, route }) {
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.contentContainer}>
                    ...
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>{t('unit3.generalDescription')}</Text>
                    ...
                    {/* Temas */}
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>{t('unit3.studyTopics')}</Text>
                        {t('unit3.topics').map((topic, index) => (
                    ...
                    {/* Fórmulas Clave */}
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>{t('unit3.keyFormulas')}</Text>
                        {t('unit3.formulas').map((formula, index) => (
                    ...
                    {unitData.simulations && unitData.simulations.length > 0 && (
                        <View style={styles.section}>
                            <Text style={styles.sectionTitle}>{t('unit3.interactiveSimulations')}</Text>
                            <Text style={styles.simulationsSubtitle}>
                                {t('unit3.simulationsSubtitle')}
                            </Text>
                    ...
                    <View style={styles.section}>
                        <Text style={styles.sectionTitle}>{t('unit3.learningObjectives')}</Text>
                        <View style={styles.objectivesCard}>
                            {t('unit3.objectives').map((objective, index) => (
